...
//     // console.log(`Адрес доставки: ${addressMap}`, ordersList);
...
//         // Создаем объект, объединяя данные формы и дополнительные данные
...
//             templateParams[key] = additionalData[key];
//         }
